...
class GcsReadOptionsTest {
  ...
  void createFromOptions_withAllProperties_shouldCreateCorrectOptions() {
    Map<String, String> properties =
        ImmutableMap.<String, String>builder()
            ...
            .put("gcs.analytics-core.file-access-pattern", "sequential")
            .put("gcs.analytics-core.min-range-request-size-bytes", "512")
            .put("gcs.analytics-core.inplace-seek-limit-bytes", "256")
            .put("gcs.analytics-core.sequential-range-read-threshold", "5")
            .build();
    String prefix = "gcs.";
  ...
  @ValueSource(
      strings = {
        ...
        "gcs.analytics-core.min-range-request-size-bytes",
        "gcs.analytics-core.inplace-seek-limit-bytes",
        "gcs.analytics-core.sequential-range-read-threshold",
      })
