...
public abstract class GcsReadOptions {
  ...
  private static final String FILE_ACCESS_PATTERN_KEY = "analytics-core.file-access-pattern";
  private static final String MIN_RANGE_REQUEST_SIZE_KEY =
      "analytics-core.min-range-request-size-bytes";
  private static final String INPLACE_SEEK_LIMIT_KEY = "analytics-core.inplace-seek-limit-bytes";
  private static final String SEQUENTIAL_RANGE_READ_THRESHOLD_KEY =
      "analytics-core.sequential-range-read-threshold";
